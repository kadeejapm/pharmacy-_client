...
function AdminEditProduct() {
     ...
     let handleSubmit = async (e)=>{
        e.preventDefault()
        let response = await axios.put(`http://localhost:3000/api/admin/edit-products/${id}`,{name:name,description:description,price:price,image:image,})
    ...
    return (
        <div className='mt-10'>
            ...
            <form onSubmit={handleSubmit} className="max-w-md mx-auto">
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <input value={price} onChange={(e)=>setPrice(e.target.value)} type="price" name="floating_price" id="floating_price" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-300 focus:outline-none focus:ring-0 focus:border-green-300 peer" placeholder=" " required />
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <input value={image} onChange={(e)=>setImage(e.target.value)} type="ImageView" name="floating_imageView" id="floating_imageView" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-300 focus:outline-none focus:ring-0 focus:border-green-300 peer" placeholder=" " required />
