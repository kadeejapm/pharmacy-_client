...
function AdminAddProduct() {
    ...
    const navigate = useNavigate()
     ...
     let handleSubmit = async (e)=>{
        e.preventDefault()
        let response = await axios.post('http://localhost:3000/api/admin/add-products',{image:image,name:name,description:description,price:price,})
    ...
    return (
        <div className='flex justify-center items-center ms-4 mt-5'>
            ...
            <img src={image}/>
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <input onChange={(e)=>setPrice(e.target.value)} type="price" name="floating_price" id="floating_price" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-green-300 focus:outline-none focus:ring-0 focus:border-green-300 peer" placeholder=" " required />
